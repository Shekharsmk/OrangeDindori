...
import com.example.OrangeDindori.staticData.Googleapiuser;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(final Bundle savedInstanceState) {
     ...
     //  MyApplication.getInstance().setConnectivityListener(this);
        ...
        mDatabaseReferenceDetail = mFirebaseDatabase.getReference().child("Product_detail");
...
//----------- ---------- ---------- ---------- ----------- --------
    ...
    public boolean onNavigationItemSelected( MenuItem item) {
        ...
        if(id == R.id.nav_my_account){
            ...
            System.out.println("going to account actibity");
            ...
            Intent instentdestion = new Intent(MainActivity.this, MyAddressesActivity.class);
            startActivity(instentdestion);
        }
        else if(id == R.id.nav_order){

            Intent instentdestion = new Intent(MainActivity.this, OrderActivity.class);
            startActivity(instentdestion);
        }else if(id == R.id.nav_cart){

            Intent instentdestion = new Intent(MainActivity.this, Cart1Activity.class);
            startActivity(instentdestion);
            ...
            String [] s = {"shekhar.smk1@gmail.com"};
           ...
           // Toast.makeText(MainActivity.this,"hi",Toast.LENGTH_SHORT).show();
            countOfItem =0;
            mListOuter.clear();
            mDatabaseReferenceDetailhome = mFirebaseDatabase.getReference().child("Product_detail");
            final ArrayList<ProductObject> mList = new ArrayList<ProductObject>();
            mRecyclerView = (RecyclerView) findViewById(R.id.rv_datainfo);
            ...
            mDatabaseReferenceDetailhome.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    mListOuter = mList;
                    mRecyclerView.setHasFixedSize(true);
                    Log.d(TAG, "onItemClicked:getdiscountPercentage() "/*+String.valueOf(mList.get(0).getDiscountPrice())+mList.get(0).getdiscountPercentage()*/);
                    mItemAdaptor = new ItemAdaptor(countOfItem, mList, MainActivity.this);
                    mRecyclerView.setAdapter(mItemAdaptor);
    ...
    private void updateViewMenuToCategory(){
        ...
        mNavigationView.getMenu().findItem(R.id.nav_my_addresses).setVisible(false);
        mNavigationView.getMenu().findItem(R.id.nav_cart).setVisible(false);
    ...
    private void updateCategorybacktoMenu(){
        ...
        mNavigationView.getMenu().findItem(R.id.nav_my_addresses).setVisible(true);
        mNavigationView.getMenu().findItem(R.id.nav_cart).setVisible(true);
    ...
    public void onItemClicked(int clikedItemIndex,ArrayList<ProductObject> filerList) {
        ...
        productSerial.setDiscountPercentage(product.getDiscountPercentage());
        Log.d(TAG, "onItemClicked:getdiscountPercentage() "+product.getDiscountPercentage());
        ...
        productSerial.setItemID(product.getItemID());
